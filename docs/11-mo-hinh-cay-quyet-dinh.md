...
<caption>(\#tab:tbtree01)Giá nhà trung bình tính theo các giá trị riêng biệt của biến rời rạc rad</caption>
 <thead>
  <tr>
...
<table class="table" style="margin-left: auto; margin-right: auto;">
<caption>(\#tab:tbtree02)Các hệ số ước lượng trong mô hình hồi quy đa biến trên dữ liệu Quảng cáo.</caption>
 <thead>
  <tr>
