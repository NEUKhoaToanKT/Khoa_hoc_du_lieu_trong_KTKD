...
<caption>(\#tab:tbbasic11)(\#tab:tbbasic11)Các từ khóa điều khiển vòng lặp</caption>
 <thead>
  <tr>
   <th style="text-align:left;"> Từ khóa </th>
   <th style="text-align:left;"> Ý nghĩa </th>
...
<div class="figure" style="text-align: center">
<img src="07-lap-trinh-co-ban-voi-R_files/figure-html/unnamed-chunk-121-1.png" alt="Vẽ đồ thị phân tán sử dụng hàm plot()" width="672" />
<p class="caption">(\#fig:unnamed-chunk-121)Vẽ đồ thị phân tán sử dụng hàm plot()</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="07-lap-trinh-co-ban-voi-R_files/figure-html/unnamed-chunk-122-1.png" alt="Mô tả mối liên hệ giữa hai biến liên tục sử dụng hàm plot()" width="672" />
<p class="caption">(\#fig:unnamed-chunk-122)Mô tả mối liên hệ giữa hai biến liên tục sử dụng hàm plot()</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="07-lap-trinh-co-ban-voi-R_files/figure-html/unnamed-chunk-123-1.png" alt="Mô tả một biến liên tục theo thời gian sử dụng hàm plot()" width="672" />
<p class="caption">(\#fig:unnamed-chunk-123)Mô tả một biến liên tục theo thời gian sử dụng hàm plot()</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="07-lap-trinh-co-ban-voi-R_files/figure-html/unnamed-chunk-124-1.png" alt="Mô tả nhiều biến liên tục theo thời gian sử dụng hàm plot() và lines()" width="672" />
<p class="caption">(\#fig:unnamed-chunk-124)Mô tả nhiều biến liên tục theo thời gian sử dụng hàm plot() và lines()</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="07-lap-trinh-co-ban-voi-R_files/figure-html/unnamed-chunk-125-1.png" alt="Mô tả phân phối của một biến bằng hàm hist()" width="672" />
<p class="caption">(\#fig:unnamed-chunk-125)Mô tả phân phối của một biến bằng hàm hist()</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="07-lap-trinh-co-ban-voi-R_files/figure-html/unnamed-chunk-126-1.png" alt="Sử dụng tham số break trong hàm hist()" width="672" />
<p class="caption">(\#fig:unnamed-chunk-126)Sử dụng tham số break trong hàm hist()</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="07-lap-trinh-co-ban-voi-R_files/figure-html/unnamed-chunk-127-1.png" alt="Sử dụng đồng thời đồ thị tần suất và hàm mật độ để mô tả phân phối xác suất" width="672" />
<p class="caption">(\#fig:unnamed-chunk-127)Sử dụng đồng thời đồ thị tần suất và hàm mật độ để mô tả phân phối xác suất</p>
</div>
...
Hàm <span style='color: #640514; font-family: Source Code Pro;'>boxplot()</span> được sử dụng để vẽ đồ thị hình hộp. Đồ thị dưới đây mô tả phân phối xác suất của véc-tơ nhiệt độ (biến Temp) trong dữ liệu <span style='color: #640514; font-family: Source Code Pro;'>airquality</span> bằng đồ thị kiểu hình hộp:

``` r
boxplot(airquality$Temp)
```

<img src="07-lap-trinh-co-ban-voi-R_files/figure-html/unnamed-chunk-128-1.png" width="672" />
...
<img src="07-lap-trinh-co-ban-voi-R_files/figure-html/unnamed-chunk-129-1.png" width="672" />
